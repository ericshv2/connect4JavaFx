    ...
    public void show() {
        ...
        backButton.setOnAction(e -> {
            try {
                ...
                System.out.println("Could not play button sound");
            }
